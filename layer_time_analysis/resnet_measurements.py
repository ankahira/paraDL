...
def main():
    ...
    # # Layer analysis
    # print("----------------------Conv 1----------------------------")
    # print(model.predictor.conv1_hook.print_report(unit="ms"))
    # print("\n")
    #
    # print("----------------------BN  1-----------------------------")
    # print(model.predictor.bn1_hook.print_report(unit="ms"))
    # print("\n")
    #
    # print("----------------------Max Pooling-----------------------")
    # print(model.predictor.max_pooling_hook.print_report(unit="ms"))
    # print("\n")
    #
    # print("----------------------Res 2-----------------------------")
    # print(model.predictor.res2_hook.print_report(unit="ms"))
    # print("\n")
    #
    # print("----------------------Res 3-----------------------------")
    # print(model.predictor.res3_hook.print_report(unit="ms"))
    # print("\n")
    #
    # print("----------------------Res 4-----------------------------")
    # print(model.predictor.res4_hook.print_report(unit="ms"))
    # print("\n")
    #
    # print("----------------------Res 5-----------------------------")
    # print(model.predictor.res5_hook.print_report(unit="ms"))
    # print("\n")
    #
    # print("----------------------Average Pooling-------------------")
    # print(model.predictor.avg_pooling_hook.print_report(unit="ms"))
    # print("\n")
    #
    # print("----------------------FC--------------------------------")
    # print(model.predictor.fc_hook.print_report(unit="ms"))
    # print("\n")
    #
