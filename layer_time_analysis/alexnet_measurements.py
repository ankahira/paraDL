...
def main():
    ...
    #
    # print("--------------------------Conv 2------------------------")
    # print(model.predictor.conv2_hook.print_report(unit="ms"))
    #
    # print("--------------------------Conv 3------------------------")
    # print(model.predictor.conv3_hook.print_report(unit="ms"))
    #
    # print("--------------------------Conv 4------------------------")
    # print(model.predictor.conv4_hook.print_report(unit="ms"))
    #
    # print("--------------------------Conv 5------------------------")
    # print(model.predictor.conv5_hook.print_report(unit="ms"))
    #
    # print("--------------------------FC 6--------------------------")
