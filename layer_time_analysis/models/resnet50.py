...
class ResNet50(chainer.Chain):
    ...
    def __init__(self):
        ...
        self.bn1_hook = TimerHook()
        self.res2_hook = TimerHook()
        self.res3_hook = TimerHook()
        self.res4_hook = TimerHook()
        self.res5_hook = TimerHook()
        self.max_pooling_hook = TimerHook()
        self.avg_pooling_hook = TimerHook()
        self.fc_hook = TimerHook()
        # For blocks
